...
class InspectionSpecification(object):
    ...
    def __init__(self, base=None, update=None, packages=None, python_packages=None, python=None, identifier=None, build=None, run=None, files=None, environment=None, script=None, local_vars_configuration=None):  # noqa: E501
